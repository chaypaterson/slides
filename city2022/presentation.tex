...
\footnotetext[1]{J.G. Galle, ``Account of the Discovery of the Planet of Le
Verrier at Berlin'', 1846, Monthly Notices of the Royal Astronomical Society 7 (1846): 153.}
\footnotetext[2]{J.P. Nichol, ``The planet Neptune: an exposition and history''
1849}
\end{frame}
}
...
\begin{frame}
    ...
    \begin{center}
        ...
        \includegraphics[width=0.60\textwidth]{figures/diagram3}
    \end{center}
